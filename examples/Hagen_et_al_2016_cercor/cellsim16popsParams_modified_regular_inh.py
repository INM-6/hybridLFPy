...
class general_params(object):
    ...
    ####################################
        ...
        # LOCALLY
            ...
            self.savefolder = 'simulation_output_modified_regular_inh'
...
class point_neuron_network_params(general_params):
    ...
    ####################################
        ...
        # time of the thalamic pulses (ms), assume 1 ms delay
        self.th_spike_times = [899. + i * 1000 for i in range(10)]
...
class multicompartment_params(point_neuron_network_params):
    ...
    ####################################
        ...
        # knockout experiment, set all excitatory weights to zero
        J_YX[J_YX >= 0] = 0.
