...
class general_params(object):
    def __init__(self):
        ...
        self.reason = 'Modified Potjans model with spontaneous activity'
    ...
    ####################################
        ...
        if 'SCRATCH' in os.environ and os.path.isdir(os.path.join(os.environ['SCRATCH'], os.environ['USER'])):
            self.savefolder = os.path.join(os.environ['SCRATCH'], os.environ['USER'],
                                           'hybrid_model',
                                           'simulation_output_modified_spontan_exc')
        # LOCALLY
        else:
            self.savefolder = 'simulation_output_modified_spontan_exc'
...
class multicompartment_params(point_neuron_network_params):
    ...
    ####################################
        ...
        if hasattr(self, 'g_4e_4i'):
            J_YX[2, 4] *= 0 #self.g_4e_4i / self.g
